...
import org.pmos.userservice.mapper.GroupsMapper;
import org.pmos.userservice.mapper.UserGroupsMapper;
import org.pmos.userservice.mapper.UserMapper;
import org.pmos.userservice.pojo.Groups;
import org.pmos.userservice.pojo.Result;
import org.pmos.userservice.pojo.UserGroups;
import org.pmos.userservice.pojo.Users;
import org.pmos.userservice.service.GroupsService;
import org.pmos.userservice.utils.NumberUtils;
...
public class GroupsServiceImpl implements GroupsService {
    ...
    public Result searchGroupsByNameOrId(String groupName) {
        ...
        Long UID= NumberUtils.parseToLongOrDefault(groupName);
        queryWrapper.like("group_name", "%"+groupName+"%").or().eq("group_id", UID);
    ...
    public Result searchGroups(String groupName, Long groupId) {
        Groups groups =groupsMapper.selectById(groupId);
        QueryWrapper<Groups> queryWrapper = new QueryWrapper<>();
        queryWrapper.like("group_name", "%"+groupName+"%"); // name 字段等于张三
        List<Groups> groupsList=groupsMapper.selectList(queryWrapper);
        if(groups!=null){
